...
### Annotated Schematics — Inspection Path Highlights

The original AMM schematics annotated with color-coded compartment zones and inspection callouts. Generated by `annotate_schematics.py`.

**Color key:** Red = Instrument Panel (highest priority), Orange = Engine Compartment (R&R #1 suspect), Yellow = Fuselage (medium priority), Green = Relay Panel / ECU (reads correctly — reference).

#### Bus Structure with Inspection Highlights

![Bus Structure Annotated](output/bus_structure_annotated.png)

#### Wiring Diagram with Inspection Highlights

![Wiring Diagram Annotated](output/wiring_diagram_annotated.png)

#### Wiring Detail with Inspection Highlights

![Wiring Detail Annotated](output/wiring_detail_annotated.png)
...
├── annotate_schematics.py     # Annotates AMM schematics with inspection highlights
...
└── output/
    ...
    ├── bus_structure_annotated.png         # AMM 24-60-00 with inspection highlights
    ├── wiring_diagram_annotated.png        # AMM CH.92 D44-9224-30-01 with highlights
    └── wiring_detail_annotated.png         # AMM CH.92 D44-9224-30-01_02 with highlights
```
